...
将气血宝珠插入生命能量具现器中,它就会从气血宝珠主人的灵魂网络中抽取LP转化成可被抽出的液态LP.(转化效率150:100)");
...
game.setLocalization("tc.research_name.WEAKORB", "虚弱宝珠粗胚");
...
game.setLocalization("tc.research_name.APPRENTICEORB", "学徒宝珠粗胚");
...
game.setLocalization("tc.research_name.MAGICANORB", "法师宝珠粗胚");
...
game.setLocalization("tc.research_name.MASTERORB", "导师宝珠粗胚");
...
game.setLocalization("tc.research_name.ARCHMAGEORB", "贤者宝珠粗胚");
...
game.setLocalization("tc.research_name.TRANSCENDENTORB", "卓越宝珠粗胚");
...
game.setLocalization("tc.research_name.ICHORIUMBLOCK", "灵宝锭块");
...
game.setLocalization("tc.research_name.ARMORINHIBITOR", "装甲约束器");
...
// --- Blood Altar
<AWWayofTime:Altar>.displayName = "格雷戈里的血之祭坛";